        ...
        <div className='w-full h-full flex  justify-end flex-col '>
            ...
            <div>
                ...
                <div className='w-full h-[100%] flex items-center justify-between'>
                    <div className=' hidden lg:flex justify-between pt-[1rem] pb-[1rem] gap-5 w-full h-full items-center'>
                        <div className='w-full flex h-full bg-transparent'>
                            <Image className='w-[100%] md:w-[50%] bg-transparent sm:object-cover object-contain' src="https://iili.io/dLCAvpt.jpg" width={500} height={500} alt='foto-banner-footer' />
                        </div>
                    ...
                    <div className='flex h-full justify-between px-4 items-center '>
                        <div className={`w-[50%] flex h-full p-1 leading-4 text-white ${neueHaasMedium.className} `}>
                        ...
                        <div className='w-fit h-fit hidden lg:flex flex-col flex-wrap text-white py-4'>
                            {links.map((link) => (
                                <li key={link.title}>
